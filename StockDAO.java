...
class StockDOAImp implements StockDAO{
    ...
    public void addProduct(StockDTO stockDTO,String table){
        try {
            Connection con = Main.connectionToDB();
    ...
    public void updateProduct(int id , StockDTO stockDTO,String table){
        try {
            Connection con = Main.connectionToDB();
            PreparedStatement ps=null;
            if(table.equals("stock_tb")){
    ...
    public void deleteUnsavedTableAfterSave(String table){
        try {
            Connection con = Main.connectionToDB();
